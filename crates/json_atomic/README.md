...
- **Property tests**: 7 testes com proptest (idempotência, UTF-8, ordenação de chaves, estabilidade CID)
- **Fuzzing**: target `fuzz_json_canonize` com >860k execuções sem crashes
- **CI**: hardening.yml com testes de propriedade e fuzz bursts

```bash
cargo test --test property_canon
```
